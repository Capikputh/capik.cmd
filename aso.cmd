@echo off
title Microsoft Activation Capikputh - Capikputh&cls&(net session >nul 2>&1)
...
:wshdisabled
echo =====================================================================================&echo.&echo Maaf, aktivasi gagal kerana Windows Script Host access is disabled.&echo.&echo Solusinya, ikuti panduan pada video tutorial yang terbuka untuk mengizinkan Windows Script.&echo.&timeout /t 7 >nul&explorer "https://youtu.be/vqGMSQnWMIY"&goto halt
:busy
echo =====================================================================================&echo.&echo.&echo Maaf, aktivasi gagal kerana koneksi internet anda tidak stabil.&echo.&echo Sila sambungkan Laptop anda ke WiFi lain kemudian ulangi lagi cara ini.&echo.&goto halt
:halt
